...
# Default scheme is tq4 — 4-bit, group size 32 (highest accuracy among 4-bit)
# Output lands next to the original: LiquidAI/LFM2-350M -> LiquidAI/LFM2-350M-TQ4
path = talu.convert(MODEL_URI)
...
#   tq4  — 4-bit, group size 32 (highest accuracy among 4-bit)
#   tq4_64  — 4-bit, group size 64 (balanced)
#   tq4_128 — 4-bit, group size 128 (smallest)
#
# 8-bit schemes (larger, more accurate)
#   tq8_32  — 8-bit, group size 32
#   tq8  — 8-bit, group size 64
#   tq8_128 — 8-bit, group size 128

# Convert with 8-bit for higher accuracy
path_8bit = talu.convert(MODEL_URI, scheme="tq8")
print(f"8-bit model: {path_8bit}")

# Aliases work too: "4bit" -> tq4, "8bit" -> tq8
...
verified = talu.convert(MODEL_URI, scheme="tq4_64", verify=True)
...
if local_path.exists():
    path_local = talu.convert(str(local_path), scheme="tq4_64")
