...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct CRelationStringList {
    pub strings: *const *const c_char,
    pub count: usize,
    pub _arena: *mut c_void,
}

impl Default for CRelationStringList {
    fn default() -> Self {
        Self {
...
#[derive(Copy, Clone)]
pub struct CKvList {
    pub items: *mut CKvEntry,
    pub count: usize,
    pub _arena: *mut c_void,
}

impl Default for CKvList {
    fn default() -> Self {
        Self {
            items: std::ptr::null_mut(),
            count: 0,
...
extern "C" {
    ...
    pub fn talu_batch_mask_to_dlpack(ids: *const u32, offsets: *const usize, num_sequences: usize, max_length: usize, padding_side: u8) -> DLManagedTensor;
    // core/src/capi/dlpack.zig
    pub fn talu_batch_to_dlpack(ids: *const u32, offsets: *const usize, num_sequences: usize, pad_id: u32, max_length: usize, padding_side: u8) -> DLManagedTensor;
    // core/src/capi/tokenizer.zig
    ...
    // core/src/capi/dlpack.zig
    pub fn talu_buffer_to_dlpack(buffer_handle: *mut c_void, offset_elems: usize, len: usize) -> DLManagedTensor;
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_free_changes(list: *mut CChangeList);
    // core/src/capi/db/table.zig
    pub fn talu_db_table_free_delta_chain(chain: *mut CDeltaChain);
    // core/src/capi/db/table.zig
    pub fn talu_db_table_free_json(ptr: *const u8, len: usize);
    // core/src/capi/db/table.zig
    pub fn talu_db_table_free_list(list: *mut CDocumentList);
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get(db_path: *const c_char, doc_id: *const c_char, out_doc: *mut CDocumentRecord) -> c_int;
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get_by_tag(db_path: *const c_char, tag_id: *const c_char, out_doc_ids: *mut *mut CStringList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get_changes(db_path: *const c_char, since_seq: u64, group_id: *const c_char, limit: u32, out_list: *mut *mut CChangeList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get_compaction_stats(db_path: *const c_char, out_stats: *mut CCompactionStats) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get_delta_chain(db_path: *const c_char, doc_id: *const c_char, out_chain: *mut *mut CDeltaChain) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get_garbage_candidates(db_path: *const c_char, out_ids: *mut *mut CStringList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_get_tags(db_path: *const c_char, doc_id: *const c_char, out_tag_ids: *mut *mut CStringList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_is_delta(db_path: *const c_char, doc_id: *const c_char, out_is_delta: *mut c_void) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_list(db_path: *const c_char, doc_type: *const c_char, group_id: *const c_char, owner_id: *const c_char, marker: *const c_char, limit: u32, out_list: *mut *mut CDocumentList) -> c_int;
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_search(db_path: *const c_char, query: *const c_char, doc_type: *const c_char, limit: u32, out_list: *mut *mut CSearchResultList) -> c_int;
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_free_list(sessions: *mut CSessionList);
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_get(db_path: *const c_char, session_id: *const c_char, out_session: *mut CSessionRecord) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_get_tags(db_path: *const c_char, session_id: *const c_char, out_tag_ids: *mut *mut CRelationStringList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_list(db_path: *const c_char, limit: u32, before_updated_at_ms: i64, before_session_id: *const c_char, group_id: *const c_char, search_query: *const c_char, tags_filter: *const c_char, tags_filter_any: *const c_char, out_sessions: *mut *mut CSessionList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_list_batch(db_path: *const c_char, offset: u32, limit: u32, group_id: *const c_char, marker_filter: *const c_char, search_query: *const c_char, tags_filter_any: *const c_char, out_sessions: *mut *mut CSessionList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_list_by_source(db_path: *const c_char, source_doc_id: *const c_char, limit: u32, before_updated_at_ms: i64, before_session_id: *const c_char, out_sessions: *mut *mut CSessionList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_session_list_ex(db_path: *const c_char, limit: u32, before_updated_at_ms: i64, before_session_id: *const c_char, group_id: *const c_char, search_query: *const c_char, tags_filter: *const c_char, tags_filter_any: *const c_char, marker_filter: *const c_char, marker_filter_any: *const c_char, model_filter: *const c_char, created_after_ms: i64, created_before_ms: i64, updated_after_ms: i64, updated_before_ms: i64, has_tags: c_int, source_doc_id: *const c_char, out_sessions: *mut *mut CSessionList) -> c_int;
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_tag_get(db_path: *const c_char, tag_id: *const c_char, out_tag: *mut CTagRecord) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_tag_get_by_name(db_path: *const c_char, name: *const c_char, group_id: *const c_char, out_tag: *mut CTagRecord) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_tag_get_conversations(db_path: *const c_char, tag_id: *const c_char, out_session_ids: *mut *mut CRelationStringList) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_tag_list(db_path: *const c_char, group_id: *const c_char, out_tags: *mut *mut CTagList) -> c_int;
    // core/src/capi/db/table.zig
