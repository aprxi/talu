...
impl From<i32> for BackendType {
    fn from(value: i32) -> Self {
        match value {
            ...
            0 => BackendType::Local,
            1 => BackendType::OpenAICompatible,
            _ => BackendType::OpenAICompatible,
        }
    }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct CCompactionPolicy {
    pub active_schema_ids: *const u16,
    pub active_schema_count: u32,
    pub tombstone_schema_id: u16,
...
impl Default for CCompactionPolicy {
    fn default() -> Self {
        Self {
            active_schema_ids: std::ptr::null(),
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct CScanParams {
    pub schema_id: u16,
    pub additional_schema_ids: *const u16,
    pub additional_schema_count: u32,
    pub filters: *const CColumnFilter,
    pub filter_count: u32,
    pub dedup_column_id: u32,
    pub delete_schema_id: u16,
    pub ts_column_id: u32,
    pub ttl_column_id: u32,
    pub limit: u32,
    pub cursor_ts: i64,
    ...
    pub reverse: bool,
    pub _pad: [u8; 3],
    pub extra_columns: *const u32,
    pub extra_column_count: u32,
}

impl Default for CScanParams {
    fn default() -> Self {
        Self {
            schema_id: 0,
            additional_schema_ids: std::ptr::null(),
            additional_schema_count: 0,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct CSchedulerConfig {
    pub max_concurrent: usize,
}

impl Default for CSchedulerConfig {
    fn default() -> Self {
        Self {
            max_concurrent: 0,
        }
...
extern "C" {
    ...
    // core/src/capi/agent/root.zig
    pub fn talu_agent_policy_check_process_detailed(policy: *mut c_void, action: *const c_char, command: *const c_char, cwd: *const c_char, out_allowed: *mut c_void, out_deny_reason: *mut c_void) -> c_int;
    // core/src/capi/agent/root.zig
    ...
    // core/src/capi/agent/root.zig
    pub fn talu_agent_policy_strict_emulation_decisions(policy: *mut c_void, cwd: *const c_char, out_deny_descendant_exec: *mut c_void, out_deny_write: *mut c_void, out_allow_python_exec: *mut c_void) -> c_int;
    // core/src/capi/agent/root.zig
    ...
    // core/src/capi/batch.zig
    pub fn talu_batch_run_loop_no_text(handle: *mut c_void, pending_flag: *mut c_void, callback: *mut c_void, callback_data: *mut c_void) -> c_int;
    // core/src/capi/batch.zig
    ...
    pub fn talu_collab_clear_snapshot(handle: *mut c_void, actor_id: *const c_char, actor_kind: u8, role: *const c_char, op_kind: *const c_char, out_result: *mut CCollabOpResult) -> c_int;
    // core/src/capi/collab.zig
    ...
    // core/src/capi/collab.zig
    pub fn talu_collab_get_history(handle: *mut c_void, after_key: *const c_char, limit: usize, out_history: *mut CCollabHistoryList) -> c_int;
    // core/src/capi/collab.zig
    pub fn talu_collab_get_presence(handle: *mut c_void, participant_id: *const c_char, out_value: *mut CCollabValue) -> c_int;
    // core/src/capi/collab.zig
    ...
    // core/src/capi/collab.zig
    pub fn talu_collab_init(db_path: *const c_char, resource_kind: *const c_char, resource_id: *const c_char, out_handle: *mut c_void) -> c_int;
    // core/src/capi/collab.zig
    pub fn talu_collab_open_session(handle: *mut c_void, participant_id: *const c_char, participant_kind: u8, role: *const c_char, out_session: *mut CCollabSession) -> c_int;
    // core/src/capi/collab.zig
    pub fn talu_collab_put_presence(handle: *mut c_void, participant_id: *const c_char, payload: *const u8, payload_len: usize, ttl_ms: u64, out_ttl_ms: *mut c_void) -> c_int;
    // core/src/capi/collab.zig
    pub fn talu_collab_submit_op(handle: *mut c_void, actor_id: *const c_char, actor_seq: u64, op_id: *const c_char, payload: *const u8, payload_len: usize, issued_at_ms: i64, has_issued_at_ms: bool, snapshot: *const u8, snapshot_len: usize, has_snapshot: bool, durability_class: u8, out_result: *mut CCollabOpResult) -> c_int;
    // core/src/capi/collab.zig
    pub fn talu_collab_watch_drain(handle: *mut c_void, after_seq: u64, max_events: usize, out_batch: *mut CCollabWatchBatch) -> c_int;
    // core/src/capi/collab.zig
    pub fn talu_collab_watch_wait(handle: *mut c_void, after_seq: u64, timeout_ms: u64, out_result: *mut CCollabWatchWaitResult) -> c_int;
    // core/src/capi/router.zig
    ...
    // core/src/capi/db/kv.zig
    pub fn talu_db_kv_put_ex(handle: *mut c_void, key: *const c_char, value: *const u8, value_len: usize, durability_class: u8, ttl_ms: u64) -> c_int;
    // core/src/capi/db/kv.zig
    pub fn talu_db_kv_stats(handle: *mut c_void, out_stats: *mut CKvNamespaceStats) -> c_int;
    // core/src/capi/db/kv.zig
    pub fn talu_db_kv_watch_drain(handle: *mut c_void, after_seq: u64, max_events: usize, out_batch: *mut CKvWatchBatch) -> c_int;
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_session_free_relation_list(list: *mut CRelationStringList);
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/table.zig
    pub fn talu_db_table_delete_row(handle: *mut c_void, pk_hash: u64, ts: i64) -> c_int;
    // core/src/capi/db/table.zig
    pub fn talu_db_table_flush(handle: *mut c_void) -> c_int;
    // core/src/capi/db/table.zig
    ...
    pub fn talu_file_bytes_free(bytes: *mut u8, len: usize);
    // core/src/capi/file.zig
    ...
    pub fn talu_scheduler_active_count(handle: *mut c_void) -> usize;
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_cancel(handle: *mut c_void, request_id: u64) -> u8;
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_create(backend: *mut c_void, config: *const CSchedulerConfig) -> *mut c_void;
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_destroy(handle: *mut c_void);
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_has_active(handle: *mut c_void) -> u8;
    // core/src/capi/scheduler.zig
    ...
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_score_tokens_kld(reference_backend: *mut c_void, model_backend: *mut c_void, context_tokens: *const u32, context_len: usize, target_tokens: *const u32, target_len: usize, max_context: usize, out_kld: *mut c_void, out_scored_tokens: *mut c_void) -> c_int;
    // core/src/capi/scheduler.zig
    ...
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_step(handle: *mut c_void, events_out: *mut CTokenEvent, max_events: usize) -> usize;
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_submit(handle: *mut c_void, tokens: *const u32, num_tokens: usize, max_tokens: usize, options: *const CSubmitOptions) -> u64;
    // core/src/capi/validate.zig
