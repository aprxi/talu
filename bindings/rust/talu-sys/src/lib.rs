...
extern "C" {
    ...
    pub fn talu_agent_prompt(
        ...
        out_result: *mut CAgentLoopResult,
    ) -> c_int;
    // core/src/capi/agent/root.zig
    ...
    pub fn talu_db_docs_list_full(
        ...
        marker: *const c_char,
        limit: u32,
        out_list: *mut *mut CDocumentFullList,
    ) -> c_int;
    // core/src/capi/db/table.zig
    ...
    // core/src/capi/db/kv.zig
    pub fn talu_db_kv_get(
        handle: *mut c_void,
        key: *const c_char,
        out_value: *mut CKvValue,
    ) -> c_int;
    // core/src/capi/db/kv.zig
    ...
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_score_tokens_kld(
    ...
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_step(
        handle: *mut c_void,
        events_out: *mut CTokenEvent,
        max_events: usize,
    ) -> usize;
    // core/src/capi/scheduler.zig
    pub fn talu_scheduler_submit(
        handle: *mut c_void,
        tokens: *const u32,
        num_tokens: usize,
        max_tokens: usize,
