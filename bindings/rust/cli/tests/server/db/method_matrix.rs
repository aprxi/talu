...
fn db_unsupported_methods_return_not_implemented_matrix() {
    ...
    let cases: &[(&str, &str)] = &[
        ...
        ("GET", "/v1/db/kv/namespaces/ns/batch"),
        ("PUT", "/v1/db/kv/namespaces/ns/batch"),
        ("PATCH", "/v1/db/kv/namespaces/ns/batch"),
        ("DELETE", "/v1/db/kv/namespaces/ns/batch"),
        ("POST", "/v1/db/kv/namespaces/ns/stats"),
        ("PUT", "/v1/db/kv/namespaces/ns/stats"),
        ("PATCH", "/v1/db/kv/namespaces/ns/stats"),
        ("DELETE", "/v1/db/kv/namespaces/ns/stats"),
        ("POST", "/v1/db/kv/namespaces/ns/watch"),
        ("PUT", "/v1/db/kv/namespaces/ns/watch"),
        ("PATCH", "/v1/db/kv/namespaces/ns/watch"),
        ("DELETE", "/v1/db/kv/namespaces/ns/watch"),
        // Blob endpoints.
        ("POST", "/v1/db/blobs"),
        ("PUT", "/v1/db/blobs"),
        ("PATCH", "/v1/db/blobs"),
