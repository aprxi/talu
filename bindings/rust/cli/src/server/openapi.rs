...
use crate::server::{
    code, collab, db, events, file, files, handlers, http, plugins, projects, proxy, pubsub, repo,
...
#[openapi(
    ...
    tags(
        ...
        (name = "Collab::Resources", description = "Collaboration session APIs over shared resources."),
        ...
        (name = "Collab::PubSub", description = "Temporary topic-based WebSocket collaboration relay used by the current editor sync path during migration to core collab resources."),
    ),
    security(
        ("gateway_secret" = []),
        ("tenant_id" = []),
    ...
    components(schemas(
        ...
        db::kv::KvBatchRequest,
        db::kv::KvBatchEntryRequest,
        db::kv::KvBatchResponse,
        db::kv::KvNamespaceStatsResponse,
        db::kv::KvWatchEvent,
        // Plugins
        plugins::PluginEntry,
