...
#[openapi(
    ...
    paths(
        ...
        // Documents
        db::docs::handle_list,
        db::docs::handle_create,
        db::docs::handle_insert,
        db::docs::handle_get,
        db::docs::handle_update,
        db::docs::handle_delete,
        db::docs::handle_search,
        db::docs::handle_get_tags,
        db::docs::handle_add_tags,
        db::docs::handle_remove_tags,
        // Files
        files::handle_upload,
        files::handle_list,
        files::handle_get,
        ...
        db::table::handle_write_row,
        db::table::handle_scan,
        db::table::handle_get_row,
        db::table::handle_delete_row,
        db::table::handle_scan_post,
        db::table::handle_list_namespaces,
        db::table::handle_get_policy,
        db::kv::handle_list,
        db::kv::handle_put,
        db::kv::handle_get,
        db::kv::handle_delete,
    ...
    components(schemas(
        ...
        // Documents
        db::docs::DocumentResponse,
        db::docs::DocumentSummaryResponse,
        db::docs::DocumentListResponse,
        db::docs::SearchResultResponse,
        db::docs::DocumentSearchResponse,
        db::docs::CreateDocumentRequest,
        db::docs::UpdateDocumentRequest,
        db::docs::DocumentSearchRequest,
        db::docs::DocumentTagsRequest,
        db::table::WriteRowRequest,
        db::table::PolicyRequest,
        db::table::ScanRequest,
        db::table::JsonColumnFilter,
        db::table::NamespacesResponse,
        db::table::JsonScalar,
        db::table::JsonRow,
        db::table::ScanResponse,
        db::table::GetResponse,
        db::table::WriteResponse,
