...
class TestDryRunSchemes:
    ...
    def test_dry_run_tq4_64(self, synthetic_model, temp_output_dir):
        """dry_run works with tq4_64 scheme."""
        result = convert(
            str(synthetic_model.path),
            output_dir=temp_output_dir,
            scheme="tq4_64",
    ...
    def test_dry_run_tq8(self, synthetic_model, temp_output_dir):
        """dry_run works with tq8 scheme."""
        result = convert(
            str(synthetic_model.path),
            output_dir=temp_output_dir,
            scheme="tq8",
        ...
        assert result["scheme"] == "tq8"
        # TQ8 is ~8.5 bits per param
