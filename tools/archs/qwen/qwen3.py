"""
Qwen3 - Pure PyTorch implementation.

Usage:
    from models.qwen.qwen3 import Qwen3

    model, tokenizer = Qwen3.from_pretrained("Qwen/Qwen3-0.6B")
...
Backend switching:
    # PyTorch (default)
    python -m talu.tests.models.test_qwen3 "Hello"

    # Zig (fast)
    TALU_BACKEND=1 python -m talu.tests.models.test_qwen3 "Hello"
"""
...
class Qwen3(nn.Module):
    ...
    def from_pretrained(model_id):
        return from_pretrained(Qwen3, model_id)
