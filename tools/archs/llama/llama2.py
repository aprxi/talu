"""
LLaMA 2 - Pure PyTorch implementation.

Usage:
    from models.llama.llama2 import Llama2

    model, tokenizer = Llama2.from_pretrained("TinyLlama/TinyLlama-1.1B-Chat-v1.0")

    ids = torch.tensor([tokenizer.encode("Hello").ids])
    logits = model(ids)

Supports: LLaMA 2, Mistral, Yi, Vicuna, TinyLlama, and compatible architectures.
"""
...
class Llama2(nn.Module):
    ...
    def from_pretrained(model_id):
        return from_pretrained(Llama2, model_id)
