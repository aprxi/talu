#!/usr/bin/env python3
"""
Test Gemma3 pure PyTorch implementation.

Run from models/:
    uv run python tests/test_gemma3.py
    uv run python tests/test_gemma3.py "Your custom prompt"
"""
...
import torch
from gemma.gemma3 import Gemma3
...
def main():
    ...
    model, tokenizer = Gemma3.from_pretrained(MODEL_ID)
