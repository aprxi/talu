#!/usr/bin/env python3
"""
Test LLaMA 3 pure PyTorch implementation.

Run from models/:
    uv run python tests/test_llama3.py
    uv run python tests/test_llama3.py "Your custom prompt"
"""
...
def main():
    ...
    model, tokenizer = Llama3.from_pretrained(MODEL_ID)
