#!/usr/bin/env python3
"""
Test Qwen3-0.6B pure PyTorch implementation.

Run from models/:
    uv run python tests/test_qwen3.py
    uv run python tests/test_qwen3.py "Your custom prompt"
"""
...
def main():
    ...
    model, tokenizer = Qwen3.from_pretrained(MODEL_ID)
