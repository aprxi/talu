...
# Pygments formatter that outputs unified hl-* classes.
_HL_MAP = {
...
def merge_css_files() -> str:
    """Merge docs CSS into a single docs/dist/style.css."""
    css_order = [
    ...
    merged.append("   Do not edit directly - modify docs/styles/docs/")
    merged.append(
        "   ============================================================================= */\n"
    )
