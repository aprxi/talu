...
//!
//! Scope note:
//! - core/src/capi/ is a broad internal boundary shared by CLI/server/bindings.
//! - This generator only produces Python ABI glue (`talu/_native.py`), not the
//!   public Python API contract (which is defined in the `talu/` modules).
//!
//! Usage:
//!   zig build gen-bindings-python
//!
...
/// C API functions owned by the Python binding.
///
/// The core C API is shared with Rust/CLI/server. Python's generated
/// `_native.py` should only expose symbols that Python production code or
/// Python binding tests call directly. Keep this list explicit so a new C
/// export does not silently become part of Python's raw binding surface.
const PYTHON_BINDING_FUNCTIONS = std.StaticStringMap(void).initComptime(.{
    .{ "talu_alloc_string", {} },
    ...
    .{ "talu_batch_mask_to_dlpack", {} },
    .{ "talu_batch_result_free", {} },
    .{ "talu_batch_run_loop", {} },
    .{ "talu_batch_run_loop_final_only", {} },
    .{ "talu_batch_submit", {} },
    .{ "talu_batch_take_result", {} },
    .{ "talu_batch_to_dlpack", {} },
    .{ "talu_batch_to_padded_tensor", {} },
    .{ "talu_buffer_create_from_copy", {} },
    .{ "talu_buffer_create_from_owned", {} },
    .{ "talu_buffer_get_data_ptr", {} },
    .{ "talu_buffer_release", {} },
    .{ "talu_buffer_to_dlpack", {} },
    .{ "talu_chat_count_tokens", {} },
    .{ "talu_chat_create", {} },
    ...
    .{ "talu_chat_max_context_length", {} },
    .{ "talu_chat_set_prompt_id", {} },
    .{ "talu_chat_set_system", {} },
    .{ "talu_chat_set_ttl_ts", {} },
    .{ "talu_clear_error", {} },
    .{ "talu_clear_response_format", {} },
    ...
    .{ "talu_execution_plan", {} },
    .{ "talu_free_spans", {} },
    .{ "talu_get_chat_template_source", {} },
    .{ "talu_grammar_compile", {} },
    .{ "talu_grammar_free", {} },
    .{ "talu_last_error", {} },
    ...
    .{ "talu_semantic_validator_check", {} },
    .{ "talu_semantic_validator_create", {} },
    .{ "talu_semantic_validator_destroy", {} },
    .{ "talu_set_log_format", {} },
    .{ "talu_set_log_level", {} },
    .{ "talu_set_response_format", {} },
    .{ "talu_set_response_format_handle", {} },
    .{ "talu_take_last_error", {} },
    .{ "talu_template_render", {} },
    .{ "talu_template_render_debug", {} },
    .{ "talu_template_render_with_filters", {} },
    .{ "talu_template_validate", {} },
    .{ "talu_text_free", {} },
    ...
    .{ "talu_tokens_concat", {} },
    .{ "talu_tokens_free", {} },
    .{ "talu_train_configure", {} },
    .{ "talu_train_create", {} },
    .{ "talu_train_destroy", {} },
    .{ "talu_train_full_configure", {} },
    .{ "talu_train_full_copy_optimizer_state_f32", {} },
    .{ "talu_train_full_copy_weights_f32", {} },
    .{ "talu_train_full_create", {} },
    .{ "talu_train_full_destroy", {} },
    .{ "talu_train_full_get_info", {} },
    .{ "talu_train_full_init_model", {} },
    .{ "talu_train_full_load_data", {} },
    .{ "talu_train_full_load_optimizer_state_f32", {} },
    .{ "talu_train_full_load_weights_f32", {} },
    .{ "talu_train_full_run", {} },
    .{ "talu_train_full_set_data", {} },
    .{ "talu_train_full_step", {} },
    .{ "talu_train_get_info", {} },
    .{ "talu_train_load_data", {} },
    .{ "talu_train_load_model", {} },
    .{ "talu_train_run", {} },
    .{ "talu_train_save_checkpoint", {} },
    .{ "talu_validate_engine_advance", {} },
    .{ "talu_validate_engine_can_accept", {} },
    .{ "talu_validate_engine_create", {} },
    .{ "talu_validate_engine_destroy", {} },
    .{ "talu_validate_engine_get_position", {} },
    .{ "talu_validate_engine_get_valid_bytes", {} },
    .{ "talu_validate_engine_is_complete", {} },
    .{ "talu_validate_engine_reset", {} },
    .{ "talu_validate_engine_validate", {} },
    .{ "talu_validate_response_format", {} },
    ...
    .{ "talu_xray_capture_is_enabled", {} },
    .{ "talu_xray_capture_overflow", {} },
    .{ "talu_xray_count_matching", {} },
    .{ "talu_xray_find_anomaly", {} },
    .{ "talu_xray_get", {} },
    .{ "talu_xray_get_data", {} },
    .{ "talu_xray_get_data_size", {} },
    .{ "talu_xray_get_samples", {} },
    .{ "talu_xray_point_name", {} },
});

fn isPythonBindingFunction(name: []const u8) bool {
    return PYTHON_BINDING_FUNCTIONS.has(name);
}

fn filterFunctionsForPythonBinding(functions: *std.ArrayListUnmanaged(FunctionSignature)) void {
    var write_index: usize = 0;
    for (functions.items) |func| {
        if (!isPythonBindingFunction(func.name)) continue;
...
pub fn main() !void {
    ...
    // Sort functions
    filterFunctionsForPythonBinding(&functions);
...
fn generatePythonBindings(
    ...
    try writer.writeAll(
        ...
        \\
        \\DO NOT EDIT - Generated by: zig build gen-bindings-python
