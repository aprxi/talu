...
const llama2_pre_block_ops = [_]types.Op{
    .{ .op_type = .embedding, .inputs = &.{.{ .tensor = "input_ids" }}, .outputs = &.{"_t0"} },
};
const llama2_post_block_ops = [_]types.Op{
    .{ .op_type = .norm, .inputs = &.{.{ .tensor = "_t_last" }}, .outputs = &.{"_t_out"} },
};
const llama2_block_ops = [_]types.Op{
...
pub var arch: types.Architecture = .{
    ...
    .block_ops = &llama2_block_ops,
    .pre_block_ops = &llama2_pre_block_ops,
    .post_block_ops = &llama2_post_block_ops,
    .block_variants = null,
    .layer_map = null,
