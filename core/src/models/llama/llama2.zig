//! Llama2 family model-version metadata.
...
pub const id: []const u8 = "llama2";
pub const family: []const u8 = "llama";
pub const version: []const u8 = "llama2";
...
/// Static block topology for Llama2-style decoder blocks.
...
const llama2_model_types = [_][]const u8{ "llama2", "mistral", "yi", "vicuna", "tinyllama" };
const llama2_weight_prefixes = [_][]const u8{ "model.layers.{d}.", "layers.{d}.", "transformer.h.{d}.", "backbone.layers.{d}.", "language_model.model.layers.{d}." };
const llama2_block_weights = [_]types.WeightSpec{
...
const llama2_perf_hints = perf.standardAttentionMlpHints("llama2");
const llama2_sampling_presets: sp.SamplingPresets = .{
    .general = .{ .temperature = 0.9, .top_p = 0.6, .top_k = 40, .presence_penalty = 0.0 },
    .coding = .{ .temperature = 0.4, .top_p = 0.6, .top_k = 40, .presence_penalty = 0.0 },
    .instruct = .{ .temperature = 0.7, .top_p = 0.6, .top_k = 40, .presence_penalty = 0.0 },
    .deterministic = .{ .temperature = 0.0, .top_p = 1.0, .top_k = 1, .presence_penalty = 0.0 },
};
pub var arch: types.Architecture = .{
    .name = "llama2",
    .model_types = &llama2_model_types,
    ...
    .performance_hints = &llama2_perf_hints,
    .sampling_presets = &llama2_sampling_presets,
};
