...
pub const CompatibilityStateView = types.CompatibilityStateView;
...
pub const compatibilityStatePointerForId = types.compatibilityStatePointerForId;
pub const validateCompatibilityStateViewForDescriptors = types.validateCompatibilityStateViewForDescriptors;
pub const writeCompatibilityStateViewToBlock = types.writeCompatibilityStateViewToBlock;
...
pub const descriptorForStateId = types.descriptorForStateId;
