//! Pipeline-owned local pipeline execution helpers.
//!
//! This module is the production entry point for local adjacent stage-chain
//! execution. Backends provide concrete stage adapters; pipeline owns the ordered
...
test "validateLocalPipelineStageBindings rejects invalid pipeline runner contract" {
...
test "executeLocalPipelineChain rejects invalid pipeline runner contract" {
    var plan_ref: local_stage_runner.LocalStageRunnerPlanRef = undefined;
    plan_ref.version = local_stage_runner.local_stage_runner_contract_version + 1;
    var placement_plan: host_capability.PlacementPlan = undefined;
...
test "executeLocalPipelineStep rejects invalid pipeline runner contract" {
    var plan_ref: local_stage_runner.LocalStageRunnerPlanRef = undefined;
    plan_ref.version = local_stage_runner.local_stage_runner_contract_version + 1;
    var placement_plan: host_capability.PlacementPlan = undefined;
