//! Fused causal prefill attention kernel wrapper for fp8 KV cache.
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_fused_prefill_heads_fp8_kv";
pub const op_name: []const u8 = "attn_fused_prefill_heads_fp8_kv";
