//! Row-strided vector add+scale kernel wrapper for modular CUDA runtime.
...
pub const embedded_symbol: [:0]const u8 = "talu_vector_add_scaled_rows_strided_f32";
pub const op_name: []const u8 = "vector_add_scaled_rows_strided_f32";
