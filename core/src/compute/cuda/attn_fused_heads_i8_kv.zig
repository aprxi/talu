//! Fused attention kernel wrapper for i8 KV cache.
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_fused_heads_i8_kv";
pub const op_name: []const u8 = "attn_fused_heads_i8_kv";
