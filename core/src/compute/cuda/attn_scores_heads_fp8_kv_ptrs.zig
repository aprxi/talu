//! Batched attention-score kernel wrapper for fp8 KV cache with pointer tables.
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_scores_heads_fp8_kv_ptrs";
pub const op_name: []const u8 = "attn_scores_heads_fp8_kv_ptrs";
