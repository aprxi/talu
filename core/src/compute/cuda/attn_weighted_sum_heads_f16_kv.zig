//! Batched attention weighted-sum kernel wrapper for f16 KV cache.
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_weighted_sum_heads_f16_kv";
pub const op_name: []const u8 = "attn_weighted_sum_heads_f16_kv";
...
pub fn runWithFunction(
    ...
    try validateArgs(probs, value_cache_f16, out, n_heads, seq_len, row_stride, kv_groups, head_dim);
...
fn validateArgs(
    ...
    if (probs.size < prob_bytes or value_cache_f16.size < cache_bytes or out.size < out_bytes) {
