//! Elementwise multiply kernel wrapper for modular CUDA runtime.
...
pub const embedded_symbol: [:0]const u8 = "talu_mul_f32_v1";
...
pub fn run(
    ...
    const resolved = try registry.resolveFunction("mul_f32", embedded_symbol);
