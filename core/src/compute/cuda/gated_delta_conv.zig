//! Gated-delta depthwise conv step wrapper.
...
pub const embedded_symbol: [:0]const u8 = "talu_gated_delta_conv_values_f32";
pub const op_name: []const u8 = "gated_delta_conv_values_f32";
