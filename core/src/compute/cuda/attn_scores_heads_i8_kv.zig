//! Batched attention-score kernel wrapper for i8 KV cache.
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_scores_heads_i8_kv";
pub const op_name: []const u8 = "attn_scores_heads_i8_kv";
...
pub fn runWithFunction(
    ...
    try validateArgs(query, key_cache_i8, k_scales, scores_out, n_heads, n_kv_heads, seq_len, row_stride, kv_groups, head_dim, scale);
...
fn validateArgs(
    ...
    if (query.size < query_bytes or key_cache_i8.size < cache_elems or scores_out.size < score_bytes) {
