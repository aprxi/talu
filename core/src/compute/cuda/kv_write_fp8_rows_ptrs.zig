//! Batched K/V cache write kernel wrapper using per-row output pointers (fp8).
...
pub const embedded_symbol: [:0]const u8 = "talu_kv_write_fp8_rows_ptrs";
pub const op_name: []const u8 = "kv_write_fp8_rows_ptrs";
