//! f32 -> bf16 conversion kernel wrapper.
...
pub const embedded_symbol: [:0]const u8 = "talu_cast_f32_to_bf16";
pub const op_name: []const u8 = "cast_f32_to_bf16";
...
pub fn runWithFunction(
    ...
    dst_bf16: *device_mod.Buffer,
    count: u32,
) !void {
    try validateArgs(src_f32, dst_bf16, count);

    arg_pack.reset();
    try arg_pack.appendBufferPtr(dst_bf16);
