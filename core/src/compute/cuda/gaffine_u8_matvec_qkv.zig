//! Fused grouped-affine U8 QKV matvec kernel wrapper.
...
pub const embedded_symbol: [:0]const u8 = "talu_gaffine_u8_matvec_qkv_f32";
pub const op_name: []const u8 = "gaffine_u8_matvec_qkv_f32";
