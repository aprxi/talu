//! Batched attention weighted-sum kernel wrapper for f16 KV cache with pointer
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_weighted_sum_heads_f16_kv_ptrs";
pub const op_name: []const u8 = "attn_weighted_sum_heads_f16_kv_ptrs";
...
pub fn runWithFunction(
    ...
    if (batch_rows == 0 or n_heads == 0 or max_seq_len == 0 or row_stride == 0 or kv_groups == 0 or head_dim == 0) return error.InvalidArgument;
