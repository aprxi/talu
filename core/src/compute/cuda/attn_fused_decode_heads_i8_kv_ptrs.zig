//! Batched fused decode-attention wrapper using per-row KV cache pointers (i8).
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_fused_decode_heads_i8_kv_ptrs";
pub const op_name: []const u8 = "attn_fused_decode_heads_i8_kv_ptrs";
