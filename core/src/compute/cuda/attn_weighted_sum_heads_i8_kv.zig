//! Batched attention weighted-sum kernel wrapper for i8 KV cache.
...
pub const embedded_symbol: [:0]const u8 = "talu_attn_weighted_sum_heads_i8_kv";
pub const op_name: []const u8 = "attn_weighted_sum_heads_i8_kv";
...
pub fn runWithFunction(
    ...
    try validateArgs(probs, value_cache_i8, v_scales, out, n_heads, n_kv_heads, seq_len, row_stride, kv_groups, head_dim);
...
fn validateArgs(
    ...
    if (probs.size < prob_bytes or value_cache_i8.size < cache_elems or out.size < out_bytes) {
