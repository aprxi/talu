...
pub const talu_scheduler_score_tokens_kld = scheduler.talu_scheduler_score_tokens_kld;
...
pub const talu_db_docs_delete = db_table.talu_db_docs_delete;
pub const talu_db_docs_delete_batch = db_table.talu_db_docs_delete_batch;
...
pub const talu_db_docs_free_json = db_table.talu_db_docs_free_json;
pub const talu_db_docs_get_changes = db_table.talu_db_docs_get_changes;
pub const talu_db_docs_free_changes = db_table.talu_db_docs_free_changes;
pub const talu_db_docs_set_ttl = db_table.talu_db_docs_set_ttl;
pub const talu_db_docs_count_expired = db_table.talu_db_docs_count_expired;
pub const talu_db_docs_create_delta = db_table.talu_db_docs_create_delta;
pub const talu_db_docs_get_delta_chain = db_table.talu_db_docs_get_delta_chain;
pub const talu_db_docs_free_delta_chain = db_table.talu_db_docs_free_delta_chain;
pub const talu_db_docs_is_delta = db_table.talu_db_docs_is_delta;
pub const talu_db_docs_get_base_id = db_table.talu_db_docs_get_base_id;
pub const talu_db_docs_get_compaction_stats = db_table.talu_db_docs_get_compaction_stats;
pub const talu_db_docs_purge_expired = db_table.talu_db_docs_purge_expired;
pub const talu_db_docs_get_garbage_candidates = db_table.talu_db_docs_get_garbage_candidates;
pub const talu_db_docs_add_tag = db_table.talu_db_docs_add_tag;
pub const talu_db_docs_remove_tag = db_table.talu_db_docs_remove_tag;
pub const talu_db_docs_get_tags = db_table.talu_db_docs_get_tags;
pub const talu_db_docs_get_by_tag = db_table.talu_db_docs_get_by_tag;
pub const talu_db_docs_free_string_list = db_table.talu_db_docs_free_string_list;

// Re-export session + tag API symbols (talu_db_session_*, talu_db_tag_*).
...
pub const talu_db_session_list = db_table.talu_db_session_list;
pub const talu_db_session_list_ex = db_table.talu_db_session_list_ex;
pub const talu_db_session_list_by_source = db_table.talu_db_session_list_by_source;
pub const talu_db_session_list_batch = db_table.talu_db_session_list_batch;
pub const talu_db_session_get = db_table.talu_db_session_get;
pub const talu_db_session_update = db_table.talu_db_session_update;
pub const talu_db_session_update_ex = db_table.talu_db_session_update_ex;
pub const talu_db_session_fork = db_table.talu_db_session_fork;
pub const talu_db_session_delete = db_table.talu_db_session_delete;
pub const talu_db_session_load_conversation = db_table.talu_db_session_load_conversation;
pub const talu_db_session_free_list = db_table.talu_db_session_free_list;
pub const talu_db_tag_list = db_table.talu_db_tag_list;
pub const talu_db_tag_get = db_table.talu_db_tag_get;
pub const talu_db_tag_get_by_name = db_table.talu_db_tag_get_by_name;
pub const talu_db_tag_create = db_table.talu_db_tag_create;
pub const talu_db_tag_update = db_table.talu_db_tag_update;
pub const talu_db_tag_delete = db_table.talu_db_tag_delete;
pub const talu_db_tag_free_list = db_table.talu_db_tag_free_list;
pub const talu_db_session_add_tag = db_table.talu_db_session_add_tag;
pub const talu_db_session_remove_tag = db_table.talu_db_session_remove_tag;
pub const talu_db_session_get_tags = db_table.talu_db_session_get_tags;
pub const talu_db_tag_get_conversations = db_table.talu_db_tag_get_conversations;
pub const talu_db_session_free_relation_list = db_table.talu_db_session_free_relation_list;
pub const talu_db_session_get_tags_batch = db_table.talu_db_session_get_tags_batch;
pub const talu_db_session_free_tag_batch = db_table.talu_db_session_free_tag_batch;
