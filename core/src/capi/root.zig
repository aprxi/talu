...
pub const talu_db_sql_query = db_storage.talu_db_sql_query;
pub const talu_db_sql_query_free = db_storage.talu_db_sql_query_free;
...
pub const talu_db_vector_init = db_storage.talu_db_vector_init;
pub const talu_db_vector_free = db_storage.talu_db_vector_free;
pub const talu_db_vector_simulate_crash = db_storage.talu_db_vector_simulate_crash;
pub const talu_db_vector_set_durability = db_storage.talu_db_vector_set_durability;
pub const talu_db_vector_append = db_storage.talu_db_vector_append;
pub const talu_db_vector_append_ex = db_storage.talu_db_vector_append_ex;
pub const talu_db_vector_append_idempotent_ex = db_storage.talu_db_vector_append_idempotent_ex;
pub const talu_db_vector_upsert = db_storage.talu_db_vector_upsert;
pub const talu_db_vector_upsert_ex = db_storage.talu_db_vector_upsert_ex;
pub const talu_db_vector_upsert_idempotent_ex = db_storage.talu_db_vector_upsert_idempotent_ex;
pub const talu_db_vector_delete = db_storage.talu_db_vector_delete;
pub const talu_db_vector_delete_idempotent = db_storage.talu_db_vector_delete_idempotent;
pub const talu_db_vector_fetch = db_storage.talu_db_vector_fetch;
pub const talu_db_vector_free_fetch = db_storage.talu_db_vector_free_fetch;
pub const talu_db_vector_stats = db_storage.talu_db_vector_stats;
pub const talu_db_vector_compact = db_storage.talu_db_vector_compact;
pub const talu_db_vector_compact_idempotent = db_storage.talu_db_vector_compact_idempotent;
pub const talu_db_vector_compact_with_generation = db_storage.talu_db_vector_compact_with_generation;
pub const talu_db_vector_compact_expired_tombstones = db_storage.talu_db_vector_compact_expired_tombstones;
pub const talu_db_vector_build_indexes_with_generation = db_storage.talu_db_vector_build_indexes_with_generation;
pub const talu_db_vector_changes = db_storage.talu_db_vector_changes;
pub const talu_db_vector_free_changes = db_storage.talu_db_vector_free_changes;
pub const talu_db_vector_load = db_storage.talu_db_vector_load;
pub const talu_db_vector_free_load = db_storage.talu_db_vector_free_load;
pub const talu_db_vector_search = db_storage.talu_db_vector_search;
pub const talu_db_vector_free_search = db_storage.talu_db_vector_free_search;
pub const talu_db_vector_search_batch = db_storage.talu_db_vector_search_batch;
pub const talu_db_vector_search_batch_ex = db_storage.talu_db_vector_search_batch_ex;
pub const talu_db_vector_scan_batch = db_storage.talu_db_vector_scan_batch;
pub const talu_db_vector_free_search_batch = db_storage.talu_db_vector_free_search_batch;
pub const talu_db_ops_set_storage_db = db_storage.talu_db_ops_set_storage_db;
pub const talu_db_ops_set_max_segment_size = db_storage.talu_db_ops_set_max_segment_size;
pub const talu_db_ops_set_durability = db_storage.talu_db_ops_set_durability;
pub const talu_db_ops_simulate_crash = db_storage.talu_db_ops_simulate_crash;
pub const talu_db_ops_vector_compact = db_storage.talu_db_ops_vector_compact;
pub const talu_db_ops_vector_build_indexes_with_generation = db_storage.talu_db_ops_vector_build_indexes_with_generation;
pub const talu_db_ops_snapshot_create = db_storage.talu_db_ops_snapshot_create;
pub const talu_db_ops_snapshot_release = db_storage.talu_db_ops_snapshot_release;
...
pub const CDocumentRecord = db_storage.CDocumentRecord;
pub const CDocumentSummary = db_storage.CDocumentSummary;
pub const CDocumentList = db_storage.CDocumentList;
pub const CDocStringList = db_storage.CDocStringList;
pub const CSearchResult = db_storage.CSearchResult;
pub const CSearchResultList = db_storage.CSearchResultList;
pub const CChangeRecord = db_storage.CChangeRecord;
pub const CChangeList = db_storage.CChangeList;
pub const CDeltaChain = db_storage.CDeltaChain;
pub const CCompactionStats = db_storage.CCompactionStats;

// Re-export unified DB table plane symbols.
pub const talu_db_table_create = db_storage.talu_db_table_create;
pub const talu_db_table_get = db_storage.talu_db_table_get;
pub const talu_db_table_get_blob_ref = db_storage.talu_db_table_get_blob_ref;
pub const talu_db_table_update = db_storage.talu_db_table_update;
pub const talu_db_table_delete = db_storage.talu_db_table_delete;
pub const talu_db_table_delete_batch = db_storage.talu_db_table_delete_batch;
pub const talu_db_table_set_marker_batch = db_storage.talu_db_table_set_marker_batch;
pub const talu_db_table_list = db_storage.talu_db_table_list;
pub const talu_db_table_free_list = db_storage.talu_db_table_free_list;
pub const talu_db_table_search = db_storage.talu_db_table_search;
pub const talu_db_table_free_search_results = db_storage.talu_db_table_free_search_results;
pub const talu_db_table_search_batch = db_storage.talu_db_table_search_batch;
pub const talu_db_table_free_json = db_storage.talu_db_table_free_json;
pub const talu_db_table_get_changes = db_storage.talu_db_table_get_changes;
pub const talu_db_table_free_changes = db_storage.talu_db_table_free_changes;
pub const talu_db_table_set_ttl = db_storage.talu_db_table_set_ttl;
pub const talu_db_table_count_expired = db_storage.talu_db_table_count_expired;
pub const talu_db_table_create_delta = db_storage.talu_db_table_create_delta;
pub const talu_db_table_get_delta_chain = db_storage.talu_db_table_get_delta_chain;
pub const talu_db_table_free_delta_chain = db_storage.talu_db_table_free_delta_chain;
pub const talu_db_table_is_delta = db_storage.talu_db_table_is_delta;
pub const talu_db_table_get_base_id = db_storage.talu_db_table_get_base_id;
pub const talu_db_table_get_compaction_stats = db_storage.talu_db_table_get_compaction_stats;
pub const talu_db_table_purge_expired = db_storage.talu_db_table_purge_expired;
pub const talu_db_table_get_garbage_candidates = db_storage.talu_db_table_get_garbage_candidates;
pub const talu_db_table_add_tag = db_storage.talu_db_table_add_tag;
pub const talu_db_table_remove_tag = db_storage.talu_db_table_remove_tag;
pub const talu_db_table_get_tags = db_storage.talu_db_table_get_tags;
pub const talu_db_table_get_by_tag = db_storage.talu_db_table_get_by_tag;
pub const talu_db_table_free_string_list = db_storage.talu_db_table_free_string_list;

pub const BlobGcStats = db_storage.BlobGcStats;
pub const BlobStreamHandle = db_storage.BlobStreamHandle;
pub const BlobWriteStreamHandle = db_storage.BlobWriteStreamHandle;
pub const CBlobStringList = db_storage.CBlobStringList;

// Re-export unified DB blob plane symbols.
pub const talu_db_blob_put = db_storage.talu_db_blob_put;
pub const talu_db_blob_gc = db_storage.talu_db_blob_gc;
pub const talu_db_blob_exists = db_storage.talu_db_blob_exists;
pub const talu_db_blob_list = db_storage.talu_db_blob_list;
pub const talu_db_blob_free_string_list = db_storage.talu_db_blob_free_string_list;
pub const talu_db_blob_open_write_stream = db_storage.talu_db_blob_open_write_stream;
pub const talu_db_blob_write_stream_write = db_storage.talu_db_blob_write_stream_write;
pub const talu_db_blob_write_stream_finish = db_storage.talu_db_blob_write_stream_finish;
pub const talu_db_blob_write_stream_close = db_storage.talu_db_blob_write_stream_close;
pub const talu_db_blob_open_stream = db_storage.talu_db_blob_open_stream;
pub const talu_db_blob_stream_read = db_storage.talu_db_blob_stream_read;
pub const talu_db_blob_stream_total_size = db_storage.talu_db_blob_stream_total_size;
pub const talu_db_blob_stream_seek = db_storage.talu_db_blob_stream_seek;
pub const talu_db_blob_stream_close = db_storage.talu_db_blob_stream_close;
