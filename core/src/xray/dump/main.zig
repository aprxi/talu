...
const io = lib.io;
const models = lib.models.dispatcher;
...
pub fn main() !void {
    ...
    var loaded = try models.loadModel(allocator, model_bundle.config_path(), model_bundle.weights_path() orelse return error.WeightsNotFound, .{}, progress_mod.ProgressContext.NONE);
    defer loaded.deinit();
