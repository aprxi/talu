//! Tests for pipeline-owned local pipeline runtime lifecycle fanout.
...
const LocalPipelineRuntime = pipeline.LocalPipelineRuntime;
const StageDecodeRequest = pipeline.local_pipeline_runtime.StageDecodeRequest;
const StageHandle = pipeline.LocalPipelineStageHandle;
const StagePrefillRequest = pipeline.local_pipeline_runtime.StagePrefillRequest;
const StageVTable = pipeline.LocalPipelineStageVTable;
...
const MockPipelineStage = struct {
    ...
    fn deviceLocationHint(ptr: *const anyopaque) ?pipeline.TensorFramePayloadLocationHint {
        _ = ptr;
        return null;
    }
};
...
const mock_pipeline_stage_vtable = StageVTable{
    ...
    .decode_external_output = MockPipelineStage.decodeExternalOutput,
    .prefill_external_output = MockPipelineStage.prefillExternalOutput,
    .decode_external_input = MockPipelineStage.decodeExternalInput,
    .prefill_external_input = MockPipelineStage.prefillExternalInput,
