//! Integration tests for responses.SchedulerRequest
//!
...
const SchedulerRequest = main.responses.SchedulerRequest;
...
test "SchedulerRequest type is accessible from responses" {
