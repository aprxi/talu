//! Integration tests for responses.Scheduler
//!
...
const Scheduler = main.responses.Scheduler;
const SchedulerConfig = main.responses.SchedulerConfig;
const SchedulerRequestState = main.responses.SchedulerRequestState;
const SchedulerTokenEvent = main.responses.SchedulerTokenEvent;
const SamplingConfig = main.responses.SamplingConfig;
const SamplingStrategy = main.responses.SamplingStrategy;

// =============================================================================
// Type Verification Tests
// =============================================================================

test "Scheduler type is accessible from responses" {
    const T = Scheduler;
    _ = T;
}
