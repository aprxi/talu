...
const ParsedToolCall = main.responses.ParsedToolCall;
const parseToolCall = main.responses.parseToolCall;
const ToolSchemaError = main.responses.ToolSchemaError;
