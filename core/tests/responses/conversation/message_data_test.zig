...
const Conversation = main.responses.conversation.Conversation;
const Item = main.responses.conversation.Item;
const MessageData = main.responses.conversation.MessageData;
const MessageRole = main.responses.conversation.MessageRole;
const ItemStatus = main.responses.conversation.ItemStatus;
const ContentType = main.responses.conversation.ContentType;
